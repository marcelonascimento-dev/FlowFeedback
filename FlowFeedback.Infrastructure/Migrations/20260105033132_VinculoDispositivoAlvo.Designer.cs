...
namespace FlowFeedback.Infrastructure.Migrations
{
    ...
    [Migration("20260105033132_VinculoDispositivoAlvo")]
    partial class VinculoDispositivoAlvo
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AlvoAvaliacaoDispositivo", b =>
                {
                    b.Property<Guid>("AlvosId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<string>("DispositivosId")
                        .HasColumnType("nvarchar(450)");

                    b.HasKey("AlvosId", "DispositivosId");

                    b.HasIndex("DispositivosId");

                    b.ToTable("DispositivoAlvos", (string)null);
                });
            ...
            modelBuilder.Entity("AlvoAvaliacaoDispositivo", b =>
                {
                    b.HasOne("FlowFeedback.Domain.Entities.AlvoAvaliacao", null)
                        .WithMany()
                        .HasForeignKey("AlvosId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("FlowFeedback.Domain.Entities.Dispositivo", null)
                        .WithMany()
